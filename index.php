    ...
    if (isset($_POST['submit'])) {
        ...
        if (isset($_FILES['photo'])) {
            ...
            if (getimagesize($uploadedFile['tmp_name'])) {
                ...
                imagecopyresized($profileImage, $profileImage, 0, 0, 0, 0, 470, 440, $profileWidth, $profileHeight);
    ...
    <div id="lightbox" class="lightbox" style="display: none;">
        <div class="lb-outerContainer">
            <div class="lb-container"><img class="lb-image" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==">
                <div class="lb-nav"><a class="lb-prev" href="https://zaveribazaar.co.in/applink/gjs_invite"></a><a class="lb-next" href="https://zaveribazaar.co.in/applink/gjs_invite"></a></div>
